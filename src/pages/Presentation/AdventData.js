const AdventData = [
  {
    id: 1,
    img: "",
    alt: "Hey baby :) For your advent calendar this year I wanted to write a letter for each of the days leading up to Christmas (including the ones we've missed ㅋㅋ).\nToday is the first day of Christmas, and I wrote you a haiku.\n\nDeep, my love for you\nLove within, love throughout\nCan you see, my love?",
  },
  {
    id: 2,
    img: "",
    alt: "It's the second day of Christmas ! hmmm actually I have a confession to make. I used to quite like reading books by Haruki Murakami. Although some of his books had many problematic themes, I felt that some of his writing was truly beautiful. Spending time with you reminds me of a quote from his book: Kafka on the shore. 'If you remember me, then I don't care if everyone else forgets.' Some people say that the fact that people remember you, is proof that you are alive. If you remember me, that is all the proof I need, to know that I am alive.",
  },
  {
    id: 3,
    img: "",
    alt: "It's the third day of Christmas ! Actually today is the day I wrote the previous letters hehe, sorry it's late. When I try to calm myself down, I imagine my heart as a big ocean. I imagine the waves that travel acrross the sea, as my feelings and emotions. The waves that crash on the shore, are the emotions that wish to be expressed. Sometimes the waves are big, and sometimes there is a storm in my ocean, but when I realize the ocean itself never moves anywhere, I can calm down. Lately, a new shore has formed on the other side of my ocean. This shore belongs to you :) As time has passed, a bridge has formed that connects my shore to yours, accross the ocean that is my heart. When I cross this bridge to come to your shore, the waves below push me along, to help me get there. But when you cross this bridge to come to my shore, the waves calm themselves down. They make sure you get accross, safely :) I hope this makes sense.",
  },
  {
    id: 4,
    img: "",
  ...
  },
  {
    id: 19,
    img: "",
    alt: "Happy 1 month baby <3 It’s the 19th day of Christmas, and it marks 1 month since we’ve started dating hehe. It feels like so much has happened in a month. I’m writing this a bit earlier than the 1 month mark, but even still it feels like a lot has happened in this short time. When time is moving quickly I like to take a moment, to look back and appreciate what has just happened. So, join me in doing so today :) I don’t think I’ll be able to fit everything in here, but I’ll fit as much as I can. On Tuesday the 21st of November, we started dating :) We brought each other flowers and expressed our feelings for one another, on a bench in front a building that you liked. When we held hands as we walked, that was the first time in 7 months that I’d held yours. Walking around with my hand in yours, felt as natural as the first time :) Then there was my birthday. You made the greatest birthday anyone could ever ask for, and I cried a lot with gratitude. The gifts, the surprise, all of the planning, things I never would of thought I’d get to experience before. Then came the next weekend. I came to your workplace for the first time, and we went to 남부터미널 to see all of the anime merchandise. I can’t get over the way your face lit up at some of the items there :) It made me so happy to have shown you one of the places I love. On the Sunday of that weekend you fell ill. When you told me you couldn’t leave your house I dropped everything to come over. We watched an episode of paradise kiss that night. That was an extra special night for me. Although you told me not to come, you still let me :) It felt like I came closer to you that night. The Tuesday after that weekend ahahaha, I won’t talk too much about it, but it was a good evening nonetheless. The weekend after, we spent 3 days together in a row :) that’s a record for us hehe. On the Friday we had an evening out with your friends, sure there were some difficult moments, but there were fun moments too <3 The weekend after that one is this one baby, I wonder what we’ll do on this one hehe. Love you",
  },
  {
    id: 20,
    img: "",
