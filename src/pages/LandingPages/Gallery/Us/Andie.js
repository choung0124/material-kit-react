...
function ImageGallery() {
  ...
  const galleryImages = [
    { id: 1, src: require("assets/images/gallery/Andie/1.jpg"), alt: "Description of image 1" },
    { id: 2, src: require("assets/images/gallery/Andie/2.jpg"), alt: "Description of image 2" },
    { id: 3, src: require("assets/images/gallery/Andie/3.jpg"), alt: "Description of image 2" },
    { id: 4, src: require("assets/images/gallery/Andie/4.jpg"), alt: "Description of image 2" },
    { id: 5, src: require("assets/images/gallery/Andie/5.jpg"), alt: "Description of image 2" },
  ];
